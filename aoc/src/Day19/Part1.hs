...
run :: IO ()
run = do
  putStrLn "Running Day 19, Part 1 solution..."
  input <- readInputFile
...
-- Calculates a Blueprint's quality level by multiplying it's ID by the maximum number of geodes it can produce
qualityLevel :: Blueprint -> Int
qualityLevel bp@Blueprint {..} = maxGeodes bp * blueprintId
...
possibleNextRobotBuilds State' {..} = S.fromList $ filter filterRobots [OreRobot, ClayRobot, ObsidianRobot, GeodeRobot]
  where
    atMaxOreRobots = robotsOreMiners stateRobots >= maximum (map priceOre [blueprintOreRobot stateBlueprint, blueprintClayRobot stateBlueprint, blueprintObsidianRobot stateBlueprint, blueprintGeodeRobot stateBlueprint])
    atMaxClayRobots = robotsClayMiners stateRobots >= maximum (map priceClay [blueprintOreRobot stateBlueprint, blueprintClayRobot stateBlueprint, blueprintObsidianRobot stateBlueprint, blueprintGeodeRobot stateBlueprint])
    atMaxObsidianRobots = robotsObsidianMiners stateRobots >= maximum (map priceObsidian [blueprintOreRobot stateBlueprint, blueprintClayRobot stateBlueprint, blueprintObsidianRobot stateBlueprint, blueprintGeodeRobot stateBlueprint])
